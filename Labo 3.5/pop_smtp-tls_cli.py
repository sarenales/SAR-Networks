...
if __name__ == "__main__":
	...
	ss.match_hostname(cert_pop, SERV_POP)

	print( "Verificado '{}'  certificado servidor POP3".format( SERV_POP ) )
	...
	LDAP = input( "Introduce tu cuenta asociada al correo del servidor local: " )
	...
	ssl_sock.sendall( msg.encode( "ascii" ) )
	msg = recvline(ssl_socks ).decode( "ascii" )
	...
	lineas.append( "{} Estudiante {} <{}>".format( FieldIMF.To, LDAP, dir_destino )  )
